...
[Slack in the #openharvest channel](https://callforcode.org/slack). Minor issues can simply be addressed by sending by a pull request.
...
reported by contacting the project team on [Slack in the #openharvest channel](https://callforcode.org/slack).
