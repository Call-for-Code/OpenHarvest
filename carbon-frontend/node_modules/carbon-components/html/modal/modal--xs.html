...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rycqj41cet">Show
  modal</button>

<div data-modal id="modal-rycqj41cet" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rycqj41cet-label" aria-describedby="modal-rycqj41cet-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rycqj41cet-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rycqj41cet-heading">Modal heading</p>
