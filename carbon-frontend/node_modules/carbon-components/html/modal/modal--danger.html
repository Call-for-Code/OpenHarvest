...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-5r3zo0bcsk">Show
  modal</button>

<div data-modal id="modal-5r3zo0bcsk" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-5r3zo0bcsk-label" aria-describedby="modal-5r3zo0bcsk-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-5r3zo0bcsk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-5r3zo0bcsk-heading">Modal heading</p>
