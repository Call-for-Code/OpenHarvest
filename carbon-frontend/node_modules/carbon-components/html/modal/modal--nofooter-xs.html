...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-71h01kl05yf">Show
  modal</button>

<div data-modal id="modal-71h01kl05yf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-71h01kl05yf-label" aria-describedby="modal-71h01kl05yf-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-71h01kl05yf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-71h01kl05yf-heading">Modal heading</p>
