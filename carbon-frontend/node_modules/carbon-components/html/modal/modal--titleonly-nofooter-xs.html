...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uvo7t5x9igj">Show
  modal</button>

<div data-modal id="modal-uvo7t5x9igj" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uvo7t5x9igj-label" aria-describedby="modal-uvo7t5x9igj-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uvo7t5x9igj-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uvo7t5x9igj-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
