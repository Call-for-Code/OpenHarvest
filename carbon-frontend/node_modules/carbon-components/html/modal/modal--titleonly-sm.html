...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-clup639x3ah">Show
  modal</button>

<div data-modal id="modal-clup639x3ah" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-clup639x3ah-label" aria-describedby="modal-clup639x3ah-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-clup639x3ah-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-clup639x3ah-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
