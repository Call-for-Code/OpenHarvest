...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-k9vqzyegnx">Show
  modal</button>

<div data-modal id="modal-k9vqzyegnx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-k9vqzyegnx-label" aria-describedby="modal-k9vqzyegnx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-k9vqzyegnx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-k9vqzyegnx-heading">Modal heading</p>
