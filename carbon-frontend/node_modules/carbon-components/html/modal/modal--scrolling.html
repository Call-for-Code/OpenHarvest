...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t7bfpa4q77a">Show
  modal</button>

<div data-modal id="modal-t7bfpa4q77a" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t7bfpa4q77a-label" aria-describedby="modal-t7bfpa4q77a-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t7bfpa4q77a-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t7bfpa4q77a-heading">Modal heading</p>
