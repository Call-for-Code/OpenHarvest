...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-q3g3tkswmx">Show
  modal</button>

<div data-modal id="modal-q3g3tkswmx" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-q3g3tkswmx-label" aria-describedby="modal-q3g3tkswmx-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-q3g3tkswmx-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-q3g3tkswmx-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
