...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-5vneu6rw63c">Show
  modal</button>

<div data-modal id="modal-5vneu6rw63c" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-5vneu6rw63c-label" aria-describedby="modal-5vneu6rw63c-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-5vneu6rw63c-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-5vneu6rw63c-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-5vneu6rw63c" class="bx--label">Text Input label</label>
        <input id="text-input-5vneu6rw63c" type="text" class="bx--text-input" placeholder="Optional placeholder text"
