...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-681q7ieftm">Show
  modal</button>

<div data-modal id="modal-681q7ieftm" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-681q7ieftm-label" aria-describedby="modal-681q7ieftm-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-681q7ieftm-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-681q7ieftm-heading">Modal heading</p>
