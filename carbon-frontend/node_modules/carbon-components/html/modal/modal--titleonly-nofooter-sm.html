...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-bi7gmgs7vea">Show
  modal</button>

<div data-modal id="modal-bi7gmgs7vea" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-bi7gmgs7vea-label" aria-describedby="modal-bi7gmgs7vea-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-bi7gmgs7vea-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-bi7gmgs7vea-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
