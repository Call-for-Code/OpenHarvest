...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-uoc2cwqckpf">Show
  modal</button>

<div data-modal id="modal-uoc2cwqckpf" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-uoc2cwqckpf-label" aria-describedby="modal-uoc2cwqckpf-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-uoc2cwqckpf-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-uoc2cwqckpf-heading">Modal heading</p>
