...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-p2nt8ju01p">Show
  modal</button>

<div data-modal id="modal-p2nt8ju01p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-p2nt8ju01p-label" aria-describedby="modal-p2nt8ju01p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-p2nt8ju01p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-p2nt8ju01p-heading">Modal heading</p>
