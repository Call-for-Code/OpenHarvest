...
export declare class PaginationNav {
    ...
    getPages(): number[];
    private getCuts;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<PaginationNav, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<PaginationNav, "ibm-pagination-nav", never, { "disabled": "disabled"; "numOfItemsToShow": "numOfItemsToShow"; "translations": "translations"; "model": "model"; }, { "selectPage": "selectPage"; }, never, never>;
}
