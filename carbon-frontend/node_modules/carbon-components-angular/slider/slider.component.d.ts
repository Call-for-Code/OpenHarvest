...
export declare class Slider implements AfterViewInit, ControlValueAccessor {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<Slider, "ibm-slider", never, { "step": "step"; "id": "id"; "shiftMultiplier": "shiftMultiplier"; "skeleton": "skeleton"; "disableArrowKeys": "disableArrowKeys"; "min": "min"; "value": "value"; "max": "max"; "disabled": "disabled"; "label": "label"; }, { "valueChange": "valueChange"; }, never, ["[minLabel]", "[maxLabel]", "input"]>;
}
